#!/usr/bin/env python3
"""
Example client for FLUX.2-klein-9B FastAPI Server

Demonstrates how to call the FLUX.2-klein-9B FastAPI server for text-to-image
...
def text_to_image(
    ...
    Args:
        ...
        guidance_scale: Guidance scale (CFG, default 1.0 for distilled model)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="FLUX.2-klein-9B FastAPI Server Example Client",
    ...
    gen_parser.add_argument("--steps", type=int, default=4, help="Number of inference steps")
    gen_parser.add_argument("--guidance", type=float, default=1.0, help="Guidance scale")
    ...
    if args.command == "health":
        ...
        print("=" * 60)
        print("FLUX.2-klein-9B FastAPI Client")
        print("=" * 60)
