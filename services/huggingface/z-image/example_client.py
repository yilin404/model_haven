#!/usr/bin/env python3
"""
Example client for Z-Image FastAPI Server

Demonstrates how to call the Z-Image FastAPI server for text-to-image
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Z-Image FastAPI Server Example Client",
    ...
    gen_parser.add_argument("--guidance", type=float, default=0.0, help="Guidance scale")
